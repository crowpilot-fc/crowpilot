...
2. With ch15 in the hover position (toward 1900 microseconds), expect `mode fader=1.00 mode=hover ch15=1900`.
3. Flip ch15 to forward (toward 1100 microseconds). The fader slews to 0.00 over 3 seconds: `fader=0.50 mode=transitioning ch15=1100` at the halfway point, then `fader=0.00 mode=forward ch15=1100`.
4. Flip back to hover. Slews 0.00 to 1.00 over 3 seconds.
5. Mid-stick ch15 (around 1500 microseconds) settles at fader=0.50 and mode=transitioning.
6. Power off the transmitter. ch15 pins to 2000 (via failsafe), fader returns to 1.00 hover.
