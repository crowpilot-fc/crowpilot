...
- Stand at least 10 metres from the aircraft during take-off. Use a take-off assistant or a tether for the first hover.
...
If you are new to multirotor, VTOL, or fixed-wing RC flight, spend several hours on a free or paid simulator before attempting CrowPilot on real hardware. Recommended free simulators: Velocidrone, Liftoff, FPV.SkyDive, AccuRC. Real-stick time on a working simulator translates directly into safer first flights on real hardware.
